...
<center>
    ...
    <form action="updateInventory.php?id=<?php echo $_GET['id']; ?>" id="form" method="POST" onsubmit="event.preventDefault();">
    <h2>Supplement resource management</h2><br>

    <table>
        <tr><td colspan="2"><center><u><h4>Edit resource entry</h4></u></center></td></tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="number" name="inventoryAmount" id="inventoryAmount" placeholder="0" value="<?php echo $inventoryDetails[2]; ?>" min="1" class="form-control"></td>
        </tr><tr><td><br></td></tr>
        <tr>
            <td>Expiry date:&nbsp;</td>
            <td><input type="text" name="expiryDate" id="expiryDate" value="<?php echo $inventoryDetails[3]; ?>" placeholder="dd/mm/yyyy" class="form-control" autocomplete="off"></td>
        </tr><tr><td><br></td></tr>
    </table>

    <input type="submit" value="Cancel" onclick="cancelBtn_OnClick();" class="btn btn-danger">
    <input type="submit" value="Update inventory" onclick="saveBtn_OnClick();" class="btn btn-success">
